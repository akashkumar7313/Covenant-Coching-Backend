              ...
              <div className="flex flex-wrap gap-20 justify-evenly">
                <div class=" mx-auto md:px-6">
                  <section class=" text-center">
                    ...
                    <div class="grid gap-x-6 pb-10 md:grid-cols-4 xl:gap-x-12">
                        ...
                        <div class="block rounded-lg bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700">
                          ...
                          <div class="p-6">
                            ...
                            <p>
                              ...
                              ducimus qui blanditiis praesentium accusamus
                      ...
                      <div class="mb-6 lg:mb-0">
                        <div class="block rounded-lg bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700">
                          <div class="relative overflow-hidden bg-cover bg-no-repeat">
                            <img
                              src="https://img.freepik.com/premium-photo/young-woman-student-protective-medical-mask-portrait-blonde-female-student-girl-university-interior-during-coronavirus-covid-19-lockdown_221542-3198.jpg?w=2000"
                              class= " w-full rounded-t-lg"
                              alt="ima"
                            />
                            <a href="#!">
                        ...
                        <div class="block rounded-lg bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700">
                          ...
                          <div class="p-6">
                            ...
                            <p>
                              ...
                              eget urna placerat vulputate. Ut vulputate est non
