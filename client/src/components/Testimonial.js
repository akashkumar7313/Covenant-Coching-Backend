...
export default function Testimonial() {
  return (
    <div className='mt-[200px] p-10 md:mt-[60px] lg:mt-[150px] mb-10 md:p-10 lg:p-10 bg-slate-100 opacity-90'>
     <div className="">
  <section className="text-center">
    <h2 className="mb-12 text-2xl font-bold">Testimonials</h2>
    <h2 className="mb-12 text-5xl font-bold">Our Successful Students</h2>

    <div className="grid gap-x-6 md:grid-cols-3 lg:gap-x-12">
      <div className="mb-12 md:mb-0">
        <div className="mb-6 flex justify-center">
          <img src="https://mdbcdn.b-cdn.net/img/Photos/Avatars/img%20(1).jpg"
            className="w-32 rounded-full shadow-lg dark:shadow-black/20" alt="User Avatar"/>
        </div>
